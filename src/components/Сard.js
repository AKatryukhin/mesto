export default class Card {
  constructor({ name, link, likes, owner, _id},currentUserId, selector, handleCardClick, handleDelCard, handleSetLike, handleRemoveLike) {
      this._name = name;
      this._link = link;
      this._id = _id;
  ...
  checkLikes() {
    this._element.querySelector('.photo__like-total').textContent = this._likes.length;
  }
